...
export const studentAPI = {
  ...
  addMockTest:     (id, data) => api.post(`/students/${id}/mock-test`, data),
  getMockTests:    (id)       => api.get(`/students/${id}/mock-tests`)
}
...
export const materialAPI = {
  ...
  upload:     (classId, formData) => api.post(`/materials/class/${classId}`, formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
...
export const assignmentAPI = {
  ...
  create:         (classId, data)      => api.post(`/assignments/class/${classId}`, data, { headers: { 'Content-Type': 'multipart/form-data' } }),
